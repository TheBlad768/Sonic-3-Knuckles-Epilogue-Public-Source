...
PlayCD_Index:
	...
	dc.l _MCD_PlayTrack<<24|$00000000				; $04 (Boss Death Ball)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+158	; $05 (Boss Ball)
	dc.l _MCD_PlayTrack<<24|$00000000				; $06 (Invincible)
	dc.l _MCD_PlayTrack_Once<<24|$00000000		; $07 (Act Clear)
	dc.l _MCD_PlayTrack_Once<<24|$00000000		; $08 (Countdown)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+398	; $09 (Prologue)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+1508	; $0A (Title Startup)
	dc.l _MCD_PlayTrack_Once<<24|$00000000		; $0B (Title Scroll)
	dc.l _MCD_PlayTrack_Once<<24|$00000000		; $0C (Title)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $0D (Sparkster)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $0E (Sparkster)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $0F (Sparkster)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $10 (Sparkster)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $11 (Sparkster)
	dc.l _MCD_PlayTrack_Loop<<24|$00000000+958	; $12 (Sparkster)
