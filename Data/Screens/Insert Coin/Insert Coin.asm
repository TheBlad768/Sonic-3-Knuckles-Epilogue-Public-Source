...
vInsertCoin_Skip:				= Object_load_addr_front+$12	; byte
...
InsertCoin_Screen:
		...
		move.w	#$E1F0,(Object_RAM+art_tile).w
...
InsertCoin_Loop:
		...
		bne.w	InsertCoin_PressStart
		tst.b	(vInsertCoin_Skip).w
		beq.s	InsertCoin_Loop
		tst.b	(Ctrl_1_pressed).w
		bpl.s	InsertCoin_Loop
...
InsertCoin_Skip_Loop:
		...
		jsr	(Render_Sprites).w
		tst.b	(vInsertCoin_End).w
		beq.s	InsertCoin_Skip_Loop

InsertCoin_PressStart:
		disableInts
		stopZ80
		dmaFillVRAM 0,$4000,$9000
		startZ80
		enableInts
...
InsertCoinScreen_Process_CheckScroll:
		...
		move.w	#$1BC,d0
		cmp.w	(Camera_Y_pos_BG_copy).w,d0
		blo.s		InsertCoinScreen_Process_CheckScroll_Return
		move.w	d0,(Camera_Y_pos_BG_copy).w
		addq.b	#2,(Object_load_routine).w
		music	bgm_Fade,0,0,0
...
InsertCoinScreen_Process_LoadFG:
		...
		move.w	#tiles_to_bytes($400),d2	; VRAM
...
InsertCoinScreen_Process_ScrollUp:
		tst.b	(Ctrl_1_pressed).w
		bmi.s	InsertCoinScreen_Process_ScrollUp_Skip
		subq.w	#1,(vInsertCoin_Timer).w
...
InsertCoinScreen_Process_ScrollUp_Skip:
		st	(InsertCoin_Flag).w
	if GameDebug=0
		jsr	(SRAM_Save).l
	endif
...
+		movea.w	parent3(a0),a1
		...
		move.w	#$F,$2E(a0)
		bra.w	Obj_DEZFallingExplosion_TailsPlane_InsertCoinScreen_Start
; ---------------------------------------------------------------------------
; Самолет тейлза
; ---------------------------------------------------------------------------
...
Emerald_InsertCoinScreen_MoveUp:
		cmpi.w	#$1EC,(Camera_Y_pos_BG_copy).w
...
Emerald_InsertCoinScreen_MoveUpFix:
		...
		addq.w	#1,y_pos(a0)
		cmpi.w	#$1BC,(Camera_Y_pos_BG_copy).w
		bne.s	Emerald_InsertCoinScreen_MoveSonic
...
.redraw:
		...
		QueueStaticDMA (RAM_Start+$2000),tiles_to_bytes((ArtUnc_TitleDeathEggSmall_End-ArtUnc_TitleDeathEggSmall)/$20),tiles_to_bytes($200)
...
Title_Deform:
		...
		cmpi.b	#id_InsertCoinScreen,(Game_mode).w
		beq.s	+
		lea	Options_BGDrawArray(pc),a4
...
Title_Deform2:
		...
		cmpi.b	#id_InsertCoinScreen,(Game_mode).w
		beq.s	+
		lea	Options_ParallaxScript(pc),a1
...
Options_ParallaxScript:
			; Mode	Speed coef.	Number of lines(Linear only)
		dc.w	_moving2|$03,	$0060		; BG
		dc.w	_moving2|$02,	$0040		; BG
		dc.w	_moving2|$03,	$0060		; BG
		dc.w	_moving2|$02,	$0040		; BG
		dc.w	_moving2|$03,	$0060		; BG
		dc.w	_moving2|$02,	$0040		; BG
...
; Space
		dc.w	_normal|$02,	$0040		; BG

; Space 2
		dc.w	_moving2|$02,	$0020		; BG

; Earth
		dc.w	_linear2|$04,		$0010,	33	; BG

; Null
		dc.w	_normal|$00,	$0000		; BG

; Clouds
		dc.w	_moving2|$04,	$0060		; BG
		dc.w	_moving2|$05,	$0040		; BG
		dc.w	_moving2|$06,	$0060		; BG
		dc.w	_moving2|$07,	$0040		; BG
		dc.w	_moving2|$08,	$0060		; BG
...
; Clouds
		dc.w	_moving2|$03,	$0060		; BG
		dc.w	_moving2|$04,	$0040		; BG
		dc.w	_moving2|$05,	$0060		; BG
		dc.w	_moving2|$06,	$0040		; BG
		dc.w	_moving2|$07,	$0060		; BG
		dc.w	_moving2|$03,	$0060		; BG
		dc.w	_moving2|$04,	$0040		; BG
		dc.w	_moving2|$05,	$0060		; BG
		dc.w	_moving2|$06,	$0040		; BG
...
PLC_InsertCoin:
		...
		plreq $1F0, ArtKosM_TitlePixel
PLC_InsertCoin_End

PLC_InsertCoin2:
		dc.w ((PLC_InsertCoin2_End-PLC_InsertCoin2)/6)-1
		plreq $1F0, ArtKosM_TitleMasterEmerald
		plreq $260, ArtKosM_TitleTailsPlane
		plreq $2E2, ArtKosM_TitleBinoculars
PLC_InsertCoin2_End
...
InsertCoin_StartupText1:		prologuestr $02, "Sonic and Tails have once again won"
InsertCoin_StartupText2:		prologuestr $02, "against the evil Dr. Robotnik."
InsertCoin_StartupText3:		prologuestr $02, "They managed to take back the"
InsertCoin_StartupText4:		prologuestr $02, "Master Emerald and were able to stop"
InsertCoin_StartupText5:		prologuestr $02, "his devious plans."

InsertCoin_StartupText6:		prologuestr $02, "But the adventure isn*t over yet..."

InsertCoin_StartupText7:		prologuestr $02, "They are celebrating their latest"
InsertCoin_StartupText8:		prologuestr $02, "victory, but had no idea the Doctor"
InsertCoin_StartupText9:		prologuestr $02, "had one last ace up his sleeve."

InsertCoin_StartupText10:		prologuestr $02, "And thus, Robotnik tracked down"
InsertCoin_StartupText11:		prologuestr $02, "the location of the heroes to take"
InsertCoin_StartupText12:		prologuestr $02, "back what belonged to him..."
...
InsertCoin_IntroTextIndex: offsetTable
		...
		offsetTableEntry.w InsertCoin_IntroText9		; 14
		offsetTableEntry.w InsertCoin_IntroTextB		; 16
		offsetTableEntry.w InsertCoin_IntroTextC		; 18
...
InsertCoin_IntroText4:		dc.b "          MAIN ARTIST PIXELCAT          ",-1

InsertCoin_IntroText5:		dc.b "       MUSIC COMPOSITOR FOXCONED        ",-1

InsertCoin_IntroText6:		dc.b "     MUSIC COMPOSITOR                   ",-1
...
InsertCoin_IntroText9:		dc.b "                                        ",$81
						dc.b "                                        ",-1

InsertCoin_IntroTextA:	dc.b "     DON*T WORRY, SONIC WON*T FALL.     ",$81
						dc.b "      THERE ISN*T THAT MUCH LEFT.       ",-1

InsertCoin_IntroTextB:	dc.b "          IT*S ALMOST TIME...           ",$81
						dc.b "                                        ",-1

InsertCoin_IntroTextC:	dc.b "          WE*RE FINALLY HERE!           ",-1
