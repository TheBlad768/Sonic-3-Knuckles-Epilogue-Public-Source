...
off_7DD5A1:
		dc.l off_7DD7A1		; Address of Palette animation data
		dc.w 1-1				; Number of colors to replace

off_7DD5A1_Start:

		dc.b 0, 0				; Index, Timer
		dc.b 1, 0



		dc.b 0, 1				; Index, Timer
		dc.b 1, 1


		dc.b 0, 2				; Index, Timer
		dc.b 1, 2


		dc.b 0, 3				; Index, Timer
		dc.b 1, 3


		dc.b 0, 4				; Index, Timer
		dc.b 1, 4


		dc.b 0, 5				; Index, Timer
		dc.b 1, 5


		dc.b 0, 6				; Index, Timer
		dc.b 1, 6


		dc.b 0, 7				; Index, Timer
		dc.b 1, 7

		dc.b 0, 8				; Index, Timer
		dc.b 1, 8

		dc.b 0, 9				; Index, Timer
		dc.b 1, 9
...
off_7DD5A1_End
		...
		dc.w $FFFC			; End
off_7DD7A1: offsetTable
		offsetTableEntry.w word_7DD881
		offsetTableEntry.w word_7DD8C1
word_7DD881:
		dc.w $E42
word_7DD8C1:
		dc.w 0
...
ShotBall_InsertCoinScreen_Process_DrawBinoculars:
		lea	off_7DD5A1(pc),a1
		lea	(Normal_palette_line_2+4).w,a2
		jsr	(Run_PalRotationScript2).w



		cmpi.b	#(off_7DD5A1_End-off_7DD5A1_Start)-2,$3B(a0)
		bne.s	ShotBall_InsertCoinScreen_Process_DrawBinoculars_Return

		clr.w	(Normal_palette_line_2+4).w
