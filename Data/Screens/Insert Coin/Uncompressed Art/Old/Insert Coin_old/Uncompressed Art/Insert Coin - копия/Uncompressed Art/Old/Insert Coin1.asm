...
InsertCoin_Screen:
		...
		move.w	#1520,(Camera_Y_pos_BG_copy).w
...
;		move.w	(Camera_Y_pos_BG_copy).w,(Camera_Y_pos).w
...
Emerald_InsertCoinScreen_Wait:
		cmp.w	#$202,(Camera_Y_pos_BG_copy).w
...
InsertCoin_IntroTextIndex: offsetTable
		...
		offsetTableEntry.w InsertCoin_IntroText6		; 8
		offsetTableEntry.w InsertCoin_IntroText7		; 8
...
InsertCoin_IntroText6:		dc.b "            SPECIAL FOR THE             ",$81
						dc.b "       SONIC HACKING CONTEST 2021       ",-1

InsertCoin_IntroText7:		dc.b "        THANKS YOU FOR PLAYING!         ",$81
						dc.b "                                        ",-1
