...
ShotBall_InsertCoinScreen_Return:
		rts
; ---------------------------------------------------------------------------
...
Obj_DEZFallingExplosion_TailsPlane_InsertCoinScreen_Wait:
		...
		subq.w	#1,$2E(a0)
		bpl.w	ShotBall_InsertCoinScreen_Return
		move.w	#$F,$2E(a0)
...
TailsPlane_InsertCoinScreen_SetAttack:
		move.w	#$2F,$2E(a0)
		move.l	#TailsPlane_InsertCoinScreen_Flash_Wait,address(a0)
...
TailsPlane_InsertCoinScreen_Flash:
		...
		beq.s	+
		move.w	#$EEE,d0
+		move.w	d0,(Normal_palette_line_1+$1E).w
...
TailsPlane_InsertCoinScreen_DeleteSprite_HScroll:
		...
		move.w	#$222,(Normal_palette_line_1+$1E).w
		move.l	#Delete_Current_Sprite,address(a0)
		lea	(Pal_InsertCoin+$A0).l,a1
		jsr	(PalLoad_Line2).w
		disableInts
...
Emerald_InsertCoinScreen_MoveUp:
		...
		bhs.s	Emerald_InsertCoinScreen_Move
...
Emerald_InsertCoinScreen_MoveUpFix:
		btst	#0,(Level_frame_counter+1).w
		beq.s	Emerald_InsertCoinScreen_Draw
		subq.w	#1,(Camera_Y_pos).w
		bne.s	Emerald_InsertCoinScreen_Draw
