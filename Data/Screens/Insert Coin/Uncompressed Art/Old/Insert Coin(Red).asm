...
vInsertCoin_RedFlag:			= Object_load_addr_front+$F	; byte
...
InsertCoinScreen_Process_Index: offsetTable
		offsetTableEntry.w InsertCoinScreen_Process_ScrollUp_IntroWaitText_Return		; 0
		...
		offsetTableEntry.w InsertCoinScreen_Process_ScrollUp_IntroWaitText_Return		; C
		offsetTableEntry.w InsertCoinScreen_Process_InitFG							; E
		offsetTableEntry.w InsertCoinScreen_Process_LoadFG							; 10
		offsetTableEntry.w InsertCoinScreen_Process_LoadText							; 12
		offsetTableEntry.w InsertCoinScreen_Process_DrawPSB							; 14
		offsetTableEntry.w InsertCoinScreen_Process_HidePSB							; 16
		offsetTableEntry.w InsertCoinScreen_Process_HideText							; 18
		offsetTableEntry.w InsertCoinScreen_Process_ScrollUp							; 1A
		offsetTableEntry.w InsertCoinScreen_Process_End								; 1C
		offsetTableEntry.w InsertCoinScreen_Process_ScrollUp_IntroWaitText_Return		; 1E
; ---------------------------------------------------------------------------
...
;		move.b	#$4F,(Negative_flash_timer).w
		...
		st	(vInsertCoin_RedFlag).w


		music	bgm_Speedup,0,0,0


		sfx2	sfx_Boom2,0,0,0
...
SonicPlane_InsertCoinScreen_Jump:
		...
		clr.l	x_vel(a0)
		bclr	#0,status(a0)
		music	bgm_Slowdown,0,0,0
		clr.b	(vInsertCoin_RedFlag).w


		sfx2	sfx_Flash,0,0,0
...
off_7DD9A:
		dc.l off_7DDCA		; Address of Palette animation data
		dc.w 2-1				; Number of colors to replace
		dc.b 0, $F			; Index, Timer
		dc.b 1, 9
		dc.b 2, 9
...
off_7DDCA: offsetTable
		offsetTableEntry.w word_7DE88		; 0
		offsetTableEntry.w word_7DE8C		; 1
		offsetTableEntry.w word_7DE90		; 2
		offsetTableEntry.w word_7DE94		; 3
		offsetTableEntry.w word_7DE98		; 4
		offsetTableEntry.w word_7DE9C		; 5
		offsetTableEntry.w word_7DEA0	; 6
word_7DE88:
		dc.w $008
		dc.w $00A
word_7DE8C:
