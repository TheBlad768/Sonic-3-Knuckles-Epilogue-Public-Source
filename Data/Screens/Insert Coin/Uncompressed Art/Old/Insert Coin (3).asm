...
TailsPlane_InsertCoinScreen_Wait:
		...
		move.l	#TailsPlane_InsertCoinScreen_ScrollUp,address(a0)

		movea.w	$44(a0),a1
		move.l	#ShotBall_InsertCoinScreen_Process_Main,address(a1)

TailsPlane_InsertCoinScreen_ScrollUp:
		subq.w	#1,(Camera_Y_pos_BG_copy).w
		subq.w	#1,(Camera_Y_pos).w
		bne.s	TailsPlane_InsertCoinScreen_Swing
		move.l	#TailsPlane_InsertCoinScreen_ScrollDown,address(a0)

TailsPlane_InsertCoinScreen_ScrollDown:
