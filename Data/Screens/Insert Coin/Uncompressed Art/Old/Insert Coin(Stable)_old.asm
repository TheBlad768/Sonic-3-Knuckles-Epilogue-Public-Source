...
;		move.w	#1520,(Camera_Y_pos_copy).w
		...
		move.w	#$850,(Camera_Y_pos_BG_copy).w
...
ShotBall_InsertCoinScreen_Process_Main:
		move.l	a0,-(sp)
		...
		move.l	#ShotBall_InsertCoinScreen_Process_Attack,address(a0)


		lea	ChildObjDat_ShotBall_Aim_InsertCoinScreen(pc),a2
...
ShotBall_InsertCoinScreen_Process_Attack:
		...
		move.b	(V_int_run_count+3).w,d0
		andi.b	#$4F,d0
		bne.s	ShotBall_InsertCoinScreen_Process_Return
...
TailsPlane_InsertCoinScreen_Wait:
		...
		move.w	#$100,x_vel(a0)
		move.w	#$2F,$2E(a0)
		move.l	#TailsPlane_InsertCoinScreen_CheckY,address(a0)

TailsPlane_InsertCoinScreen_CheckY:
		addq.w	#2,$34(a0)
		cmpi.w	#$80,$34(a0)
		blo.s		TailsPlane_InsertCoinScreen_Swing
		move.b	#1,$40(a0)
		move.l	#TailsPlane_InsertCoinScreen_CheckX,address(a0)

TailsPlane_InsertCoinScreen_CheckX:
		cmpi.w	#$D0,x_pos(a0)
		ble.s		TailsPlane_InsertCoinScreen_Swing
		move.w	#$4F,$2E(a0)
		move.l	#TailsPlane_InsertCoinScreen_Wait2,address(a0)
		clr.w	x_vel(a0)


TailsPlane_InsertCoinScreen_Wait2:
		subq.w	#1,$2E(a0)
		bpl.s	TailsPlane_InsertCoinScreen_Swing
		move.l	#TailsPlane_InsertCoinScreen_Swing,address(a0)

		movea.w	$44(a0),a1
		move.l	#ShotBall_InsertCoinScreen_Process_Main,address(a1)
