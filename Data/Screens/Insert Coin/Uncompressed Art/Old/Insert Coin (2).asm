...
Obj_TailsPlane_InsertCoinScreen:
		...
		lea	ChildObjDat_TailsPlane_Propeller_InsertCoinScreen(pc),a2
...
ChildObjDat_TailsPlane_Propeller_InsertCoinScreen:
		dc.w 3-1
