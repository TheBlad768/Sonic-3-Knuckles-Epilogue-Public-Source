...
SRAMError_MainText:
		...
		dc.b "    ALL YOUR RECORDS HAVE BEEN LOST.",$84
		dc.b "         WE ARE DEEPLY SORRY...",$8D
		dc.b "    PRESS *START* BUTTON TO CONTINUE",-1
SRAMError_Main2Text:
		dc.b "     THE SRAM INITIALIZATION ERROR.     ",$82
		dc.b "    ALL YOUR DATA WILL NOT BE SAVED.",$84
		dc.b "         WE ARE DEEPLY SORRY...",$8E
		dc.b "    PRESS *START* BUTTON TO CONTINUE",-1
	even
