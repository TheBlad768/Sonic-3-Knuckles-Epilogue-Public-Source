...
vTimeAttack_Timer:			= Object_load_addr_front		; word
vTimeAttack_TextFactor:		= Object_load_addr_front+2	; byte
vTimeAttack_End:			= Object_load_addr_front+3	; byte
vTimeAttack_Wait:			= Object_load_addr_front+4	; byte
...
TimeScreen_Process_LoadText:
		...
		move.l	#vTimeAttack_Buffer>>1,d1
...
TimeScreen_LoadDataToPlane_Death_Null:
		addq.w	#1,d1
		bne.s	TimeScreen_LoadDataToPlane_Death_Win
		moveq	#$33,d2
		move.w	#$2340,d3
		cmp.b	(TimeAttack_flag).w,d6
		bne.s	.skip
...
.skip:
		add.w	d3,d2
		move.w	d2,VDP_data_port-VDP_data_port(a6)		; X
		move.w	d2,VDP_data_port-VDP_data_port(a6)		; X
		move.w	d2,VDP_data_port-VDP_data_port(a6)		; X
		bra.s	TimeScreen_LoadDataToPlane_Death_Next
; ---------------------------------------------------------------------------

TimeScreen_LoadDataToPlane_Death_Win:
		addq.w	#1,d1
		bne.s	TimeScreen_LoadDataToPlane_Death_Alt
		move.w	#$2340,d3
		cmp.b	(TimeAttack_flag).w,d6
		bne.s	.skip
		move.w	#$4340,d3
...
TimeScreen_LoadDataToPlane_Death_Alt:
		addq.w	#1,d1
		bne.s	TimeScreen_LoadDataToPlane_Death_Cheat
		move.w	#$2340,d3
		cmp.b	(TimeAttack_flag).w,d6
		bne.s	.skip
		move.w	#$4340,d3
...
TimeScreen_LoadDataToPlane_Death_Cheat:
		move.w	#$2340,d3
		cmp.b	(TimeAttack_flag).w,d6
		bne.s	.skip
		move.w	#$4340,d3
...
.skip:
		...
		add.w	d3,d2
		move.w	d2,VDP_data_port-VDP_data_port(a6)
		bra.w	TimeScreen_LoadDataToPlane_Death_Next
