...
Time_NameTextIndex: offsetTable
		offsetTableEntry.w Time_NameYouText	; 0
		offsetTableEntry.w Time_NameBladText	; 2
		offsetTableEntry.w Time_NameFoxText	; 4
		offsetTableEntry.w Time_NameNarText	; 6
		offsetTableEntry.w Time_NameCatText	; 8
		offsetTableEntry.w Time_NameTishaText	; A
