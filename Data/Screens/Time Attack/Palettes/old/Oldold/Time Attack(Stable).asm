...
loc_37476:
		...
		move.l	d0,4(a1)
		move.b	(TimeAttack_Count).w,4(a1)
...
loc_3749A:
		...
		move.l	d0,8(a1)
		move.b	(TimeAttack_Count).w,8(a1)
...
loc_374AA:
		...
		move.l	d0,$C(a1)
		move.b	(TimeAttack_Count).w,$C(a1)
...
loc_374BA:
		...
		move.l	d0,$10(a1)
		move.b	(TimeAttack_Count).w,$10(a1)
...
loc_374CA:
		...
		move.l	d0,$14(a1)
		move.b	(TimeAttack_Count).w,$14(a1)
...
loc_374DA:
		...
		move.l	d0,$18(a1)
		move.b	(TimeAttack_Count).w,$18(a1)
...
loc_374EA:
		...
		move.l	d0,$1C(a1)
		move.b	(TimeAttack_Count).w,$1C(a1)
...
loc_374FA:
		...
		move.l	d0,$20(a1)
		move.b	(TimeAttack_Count).w,$20(a1)
...
loc_3750A:
		...
		move.l	d0,$24(a1)
		move.b	(TimeAttack_Count).w,$24(a1)
