...
RocketMap macro count, xpos, ypos, wait, subtype, render
	dc.w count
	dc.w xpos, ypos, wait
	dc.b subtype, render
    endm
...
; 2
		dc.w $180, $60		; Xpos, Ypos
		dc.w $2F				; Wait
		dc.b 1, 0				; Subtype, Render bitfield

; 1
		dc.w $180, $A0		; Xpos, Ypos
		dc.w $4F				; Wait
		dc.b 1, 0				; Subtype, Render bitfield
...
; 1
		dc.w $180, $40		; Xpos, Ypos
		dc.w $4F				; Wait
		dc.b 1, 0				; Subtype, Render bitfield

; 2
		dc.w $180, $80		; Xpos, Ypos
		dc.w $2F				; Wait
		dc.b 1, 0				; Subtype, Render bitfield

; 3
		dc.w $180, $C0		; Xpos, Ypos
		dc.w $F				; Wait
		dc.b 1, 0				; Subtype, Render bitfield
...
; 8
		dc.w $100, $100		; Xpos, Ypos
		dc.w $15F			; Wait
		dc.b $81, 0			; Subtype, Render bitfield

; 9
		dc.w $120, $100		; Xpos, Ypos
		dc.w $18F			; Wait
		dc.b $81, 0			; Subtype, Render bitfield
