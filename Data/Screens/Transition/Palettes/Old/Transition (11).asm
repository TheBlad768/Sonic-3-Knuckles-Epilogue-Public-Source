...
TransitionScreen_Process_Index: offsetTable
		offsetTableEntry.w TransitionScreen_Process_Init			; 0
		offsetTableEntry.w TransitionScreen_Process_Wait		; 2

		offsetTableEntry.w TransitionScreen_Process_CheckPress	; 2
		offsetTableEntry.w TransitionScreen_Process_CheckPress_Exit
