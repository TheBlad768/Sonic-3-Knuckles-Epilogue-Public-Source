...
TransitionScreen_LoadRocket_Process_End:
		move.l	#TransitionScreen_LoadRocket_Process_Return,address(a0)
...
TransitionScreen_LoadRocket_Index: offsetTable
		...
		offsetTableEntry.w .Data1					; 2
		offsetTableEntry.w .Data1					; 4
		offsetTableEntry.w .Data1					; 6
; ---------------------------------------------------------------------------
...
Obj_TransitionRocket:
		...
		lea	ChildObjDat_TransitionRocketFace(pc),a2
		jsr	(CreateChild6_Simple).w


		move.l	#AniRaw_TransitionRocket2,$30(a0)
...
Obj_TransitionRocketFace:
		...
		move.l	#AniRaw_TransitionRocketFace2,$30(a0)
...
ObjDat3_TransitionRocketFace:
		...
		dc.b 2
		dc.b 0
ChildObjDat_TransitionRocketFace:
		dc.w 1-1
		dc.l Obj_TransitionRocketFace
AniRaw_TransitionRocket:		dc.b 1, 0, 1, $FC
AniRaw_TransitionRocket2:	dc.b 1, 7, 8, $FC
AniRaw_TransitionRocketFace:
		dc.b 2, 3
		dc.b 3, 3
		dc.b 4, 3
		dc.b $E, 7
