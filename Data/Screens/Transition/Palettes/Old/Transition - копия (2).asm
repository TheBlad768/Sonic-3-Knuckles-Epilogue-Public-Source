...
TransitionScreen_Process_Index: offsetTable
		...
		offsetTableEntry.w TransitionScreen_Process_MoveWait			; E
		offsetTableEntry.w TransitionScreen_Process_MoveCamera			; 10
		offsetTableEntry.w TransitionScreen_Process_CheckSonic			; 12
		offsetTableEntry.w TransitionScreen_Process_CheckSonic_Return	; 14
; ---------------------------------------------------------------------------
...
TransitionScreen_LoadRocket_Index: offsetTable
		...
		offsetTableEntry.w .Data7					; 6
		offsetTableEntry.w .Data8					; 7
		offsetTableEntry.w .Data5					; 8
		offsetTableEntry.w .Data6					; 9
		offsetTableEntry.w .Data9					; A
		offsetTableEntry.w .DataA					; B
		offsetTableEntry.w .DataB					; C
		offsetTableEntry.w .Data4					; D
		offsetTableEntry.w .Data5					; E
		offsetTableEntry.w .Data6					; F
		offsetTableEntry.w .DataA					; 10
		offsetTableEntry.w .DataC					; 11
		offsetTableEntry.w .DataD					; 12
		offsetTableEntry.w .DataE					; 13
		offsetTableEntry.w .DataF					; 14
		offsetTableEntry.w .Data11					; 15
		offsetTableEntry.w .Data10					; 16
		offsetTableEntry.w .Data12					; 17
		offsetTableEntry.w .Data13					; 18
		offsetTableEntry.w .Data12					; 19
...
__LABEL__ label *
	dc.w (((__LABEL___End - __LABEL__) / 8) - 1)
    endm

RocketMap macro xpos, ypos, wait, subtype, render
		dc.w xpos, ypos, wait
		dc.b subtype, render
    endm
; ---------------------------------------------------------------------------
...
.Data1: RocketMap_Header
		RocketMap $180, $20, $F, 1, 0	; 1
.Data1_End
; ---------------------------------------------------------------------------

.Data2: RocketMap_Header
		RocketMap $180, $C0, $F, 1, 0	; 1
.Data2_End
; ---------------------------------------------------------------------------

.Data3: RocketMap_Header
		RocketMap $180, $40, $F, 1, 0	; 1
		RocketMap $180, $A0, $F, 1, 0	; 2
.Data3_End
; ---------------------------------------------------------------------------

.Data4: RocketMap_Header
		RocketMap $180, $20, $F, 1, 0	; 1
		RocketMap $180, $50, $4F, 1, 0	; 2
		RocketMap $180, $90, $4F, 1, 0	; 3
		RocketMap $180, $C0, $F, 1, 0	; 4
.Data4_End
; ---------------------------------------------------------------------------

.Data5: RocketMap_Header
		RocketMap $180, $20, $F, 1, 0	; 1
		RocketMap $180, $60, $2F, 1, 0	; 2
		RocketMap $180, $A0, $4F, 1, 0	; 3
.Data5_End
; ---------------------------------------------------------------------------

.Data6: RocketMap_Header
		RocketMap $180, $40, $4F, 1, 0	; 1
		RocketMap $180, $80, $2F, 1, 0	; 2
		RocketMap $180, $C0, $F, 1, 0	; 3
.Data6_End
; ---------------------------------------------------------------------------

.Data7: RocketMap_Header
		RocketMap $20, $100, $F, $81, 0	; 1
		RocketMap $40, $100, $3F, $81, 0	; 2
		RocketMap $60, $100, $6F, $81, 0	; 3
		RocketMap $80, $100, $9F, $81, 0	; 4
		RocketMap $A0, $100, $CF, $81, 0	; 5
		RocketMap $C0, $100, $FF, $81, 0	; 6
		RocketMap $E0, $100, $12F, $81, 0	; 7
		RocketMap $100, $100, $15F, $81, 0	; 8
		RocketMap $120, $100, $18F, $81, 0	; 9
.Data7_End
; ---------------------------------------------------------------------------

.Data8: RocketMap_Header
		RocketMap $20, $100, $18F, $81, 0	; 1
		RocketMap $40, $100, $15F, $81, 0	; 2
		RocketMap $60, $100, $12F, $81, 0	; 3
		RocketMap $80, $100, $FF, $81, 0	; 4
		RocketMap $A0, $100, $CF, $81, 0	; 5
		RocketMap $C0, $100, $9F, $81, 0	; 6
		RocketMap $E0, $100, $6F, $81, 0	; 7
		RocketMap $100, $100, $3F, $81, 0	; 8
		RocketMap $120, $100, $F, $81, 0	; 9
.Data8_End
; ---------------------------------------------------------------------------

.Data9: RocketMap_Header
		RocketMap $48, $100, $F, $81, 0	; 1
		RocketMap $A8, $100, $3F, $81, 0	; 2
		RocketMap $108, $100, $F, $81, 0	; 3
		RocketMap $68, $100, $6F, $81, 0	; 4
		RocketMap $E8, $100, $6F, $81, 0	; 5
		RocketMap $28, $100, $9F, $81, 0	; 6
		RocketMap $128, $100, $9F, $81, 0	; 7
.Data9_End
; ---------------------------------------------------------------------------

.DataA: RocketMap_Header
		RocketMap $40, $100, $F, $81, 0	; 1
		RocketMap $A0, $100, $F, $81, 0	; 2
		RocketMap $108, $100, $F, $81, 0	; 3
.DataA_End
; ---------------------------------------------------------------------------
...
.DataB: RocketMap_Header
		RocketMap $20, $100, $F, $81, 0	; 1
		RocketMap $70, $100, $F, $81, 0	; 2
		RocketMap $D0, $100, $F, $81, 0	; 3
		RocketMap $120, $100, $F, $81, 0	; 4
.DataB_End
; ---------------------------------------------------------------------------

.DataC: RocketMap_Header
		RocketMap $180, $20, $F, 1, 0		; 1
		RocketMap $180, $40, $3F, 1, 0		; 2
		RocketMap $180, $60, $6F, 1, 0		; 3
		RocketMap $180, $80, $9F, 1, 0		; 4
		RocketMap $180, $A0, $CF, 1, 0		; 5
		RocketMap $180, $C0, $FF, 1, 0		; 6
.DataC_End
; ---------------------------------------------------------------------------

.DataD: RocketMap_Header
		RocketMap $180, $20, $FF, 1, 0		; 1
		RocketMap $180, $40, $CF, 1, 0		; 2
		RocketMap $180, $60, $9F, 1, 0		; 3
		RocketMap $180, $80, $6F, 1, 0		; 4
		RocketMap $180, $A0, $3F, 1, 0		; 5
		RocketMap $180, $C0, $F, 1, 0		; 6
.DataD_End
; ---------------------------------------------------------------------------

.DataE: RocketMap_Header
		RocketMap $180, $20, $F, 2, 0	; 1
.DataE_End
; ---------------------------------------------------------------------------

.DataF: RocketMap_Header
		RocketMap $180, $C0, $F, 2, 0	; 1
.DataF_End
; ---------------------------------------------------------------------------

.Data10: RocketMap_Header
		RocketMap $20, $100, $F, $82, 0	; 1
		RocketMap $40, $100, $2F, $82, 0	; 2
		RocketMap $60, $100, $4F, $82, 0	; 3
		RocketMap $80, $100, $6F, $82, 0	; 4
		RocketMap $A0, $100, $8F, $82, 0	; 5
		RocketMap $C0, $100, $AF, $82, 0	; 6
		RocketMap $E0, $100, $CF, $82, 0	; 7
		RocketMap $100, $100, $EF, $82, 0	; 8
		RocketMap $120, $100, $10F, $82, 0	; 9
.Data10_End
; ---------------------------------------------------------------------------

.Data11: RocketMap_Header
		RocketMap $20, $100, $10F, $82, 0	; 1
		RocketMap $40, $100, $EF, $82, 0	; 2
		RocketMap $60, $100, $CF, $82, 0	; 3
		RocketMap $80, $100, $AF, $82, 0	; 4
		RocketMap $A0, $100, $8F, $82, 0	; 5
		RocketMap $C0, $100, $6F, $82, 0	; 6
		RocketMap $E0, $100, $4F, $82, 0	; 7
		RocketMap $100, $100, $2F, $82, 0	; 8
		RocketMap $120, $100, $F, $82, 0	; 9
.Data11_End
; ---------------------------------------------------------------------------

.Data12: RocketMap_Header
		RocketMap $180, $40, $F, 2, 0	; 1
		RocketMap $180, $A0, $F, 2, 0	; 2
.Data12_End
; ---------------------------------------------------------------------------

.Data13: RocketMap_Header
		RocketMap $180, $20, $F, 3, 0		; 1
		RocketMap $180, $C0, $4F, 3, 0		; 2
		RocketMap $180, $60, $8F, 3, 0		; 3
		RocketMap $180, $40, $CF, 3, 0		; 4
		RocketMap $180, $A0, $10F, 3, 0	; 5
		RocketMap $180, $20, $14F, 3, 0	; 6
		RocketMap $180, $60, $18F, 3, 0	; 7
		RocketMap $180, $C0, $1CF, 3, 0	; 8
		RocketMap $180, $40, $20F, 3, 0	; 9
		RocketMap $180, $20, $24F, 3, 0	; 10
		RocketMap $180, $60, $28F, 3, 0	; 11
		RocketMap $180, $C0, $2CF, 3, 0	; 12
		RocketMap $180, $80, $30F, 3, 0	; 13
		RocketMap $180, $20, $34F, 3, 0	; 14
.Data13_End
; ---------------------------------------------------------------------------
...
PLC_Transition: plrlistheader
		...
		plreq $240, ArtKosM_TransitionRocket
		plreq $2A0, ArtKosM_BossGreyBall_Asteroid
PLC_Transition_End
