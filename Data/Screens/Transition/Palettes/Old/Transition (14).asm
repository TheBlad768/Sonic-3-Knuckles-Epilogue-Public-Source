...
TransitionScreen_Process_Index: offsetTable
		...
		offsetTableEntry.w TransitionScreen_Process_CreateRocket			; 4
		offsetTableEntry.w TransitionScreen_Process_AttackRocket			; 6
		offsetTableEntry.w TransitionScreen_Process_AttackRocket_End		; 8
		offsetTableEntry.w TransitionScreen_Process_MoveCenter			; A
		offsetTableEntry.w TransitionScreen_Process_MoveWait			; C
		offsetTableEntry.w TransitionScreen_Process_MoveCamera			; E
		offsetTableEntry.w TransitionScreen_Process_CheckSonic			; 10
		offsetTableEntry.w TransitionScreen_Process_CheckSonic_Return	; 12
; ---------------------------------------------------------------------------
...
TransitionScreen_LoadRocket_Index: offsetTable
		...
		offsetTableEntry.w .Data9					; C
		offsetTableEntry.w .DataA					; D
		offsetTableEntry.w .Data9					; E
		offsetTableEntry.w .DataA					; F
...
.Data9: RocketMap_Header
		...
		RocketMap $A0, $100, $3F, $81, 0	; 2
		RocketMap $100, $100, $F, $81, 0	; 3
		RocketMap $60, $100, $6F, $81, 0	; 4
		RocketMap $E0, $100, $6F, $81, 0	; 5
		RocketMap $A0, $100, $9F, $81, 0	; 6
.Data9_End
; ---------------------------------------------------------------------------

.DataA: RocketMap_Header
		RocketMap $50, $100, $F, $81, 0	; 1
		RocketMap $B0, $100, $F, $81, 0	; 3
.DataA_End
; ---------------------------------------------------------------------------
...
Transition_Asteroids_Load:
		...
		jsr	(Create_New_Sprite).w
		bne.w	Transition_Asteroids_Load_Return
		move.l	#RobotnikJetpack_Intro_Draw,address(a1)
