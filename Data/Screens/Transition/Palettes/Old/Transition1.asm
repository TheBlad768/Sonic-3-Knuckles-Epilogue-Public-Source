...
TransitionScreen_Process_Index: offsetTable
		...
		offsetTableEntry.w TransitionScreen_Process_AttackRocket			; 2
		offsetTableEntry.w TransitionScreen_Process_AttackRocket_End		; 4
		offsetTableEntry.w TransitionScreen_Process_MoveCenter			; 6
		offsetTableEntry.w TransitionScreen_Process_MoveWait			; 8
		offsetTableEntry.w TransitionScreen_Process_MoveCamera			; A
		offsetTableEntry.w TransitionScreen_Process_CheckSonic			; C
		offsetTableEntry.w TransitionScreen_Process_CheckSonic_Return	; E
; ---------------------------------------------------------------------------
...
; Load
		lea	TransitionScreen_Process_ObjIndex(pc),a2
		moveq	#2-1,d6
...
TransitionScreen_Process_ObjIndex:
		dc.l Obj_Crane_TransitionScreen		; 0
		dc.l Obj_TransitionScreen_LoadRocket	; 1
; ---------------------------------------------------------------------------
