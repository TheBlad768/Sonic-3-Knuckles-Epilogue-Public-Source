...
Death_Screen:
	...
	if GameDebug=0
		...
		move.l	#No_Resize,(Level_data_addr_RAM.Resize).w
...
DeathScreen_Process_Index: offsetTable
		...
		offsetTableEntry.w DeathScreen_Process_PressButton		; 8
		offsetTableEntry.w DeathScreen_Process_End				; A
; ---------------------------------------------------------------------------
...
DeathScreen_Process_DrawText_Skip:
		...
		bne.s	DeathScreen_Process_DrawText_Skip_Return
...
DeathScreen_Process_HideText_Skip:
		...
		cmpi.b	#(Death_TextIndex_End-Death_TextIndex)-2,(vDeath_TextIndex).w
...
DeathScreen_Process_PressButton:
		move.b	(Ctrl_1_pressed).w,d0
		andi.b	#JoyABCS,d0
		beq.s	DeathScreen_Process_PressButton_Return
		move.b	#6,(Object_load_routine).w
		move.b	#$14,(vDeath_TextFactor).w
		move.w	#$1F,(vDeath_Timer).w

DeathScreen_Process_PressButton_Return:
		rts
; ---------------------------------------------------------------------------
...
SonicSurfboarding_DeathScreen_PLC:
		...
		bmi.s	+
		move.w	#$8000,d4
		move.l	#ArtUnc_SonicSurfboarding>>1,d6
