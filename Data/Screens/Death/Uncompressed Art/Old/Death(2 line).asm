...
DeathScreen_Process_HideText_Skip:
		...
		cmpi.b	#(Death_TextIndex_End-Death_TextIndex),(vDeath_TextIndex).w
...
DeathScreen_LoadSpriteText:
		moveq	#0,d0
		lea	(Sprite_table_buffer+(8*4)).w,a6
		...
		move.w	d1,d4					; Save Xpos
		move.w	#$98,d3					; Main Ypos

DeathScreen_LoadSpriteText_Loop:
		cmpi.b	#19,d6
		bne.s	DeathScreen_LoadSpriteText_Check
		addi.w	#$10,d3
		move.w	d4,d1

DeathScreen_LoadSpriteText_Check:
		cmpi.b	#$37,(a1)				; Space
...
Death_Text1:	optionstr "Did you lose? Again?Did you lose? Again?"
