...
; RAM
Music_test_count:			= Object_load_addr_front+4	; word
Sound_test_count:			= Object_load_addr_front+6	; word
v_LeveSelect_PlayFlag:			= Object_load_addr_front+8	; byte
v_LeveSelect_VCount:			= Object_load_addr_front+$A	; word
v_LeveSelect_HCount:			= Object_load_addr_front+$C	; word($10 bytes)
...
LeveSelect_FlashingTestCount:	= 7
LeveSelect_QuickTestCount:	= LeveSelect_FlashingTestCount+1
LeveSelect_MusicTestCount:	= LeveSelect_QuickTestCount+1
...
-		clr.w	(a3)+
		...
		bsr.w	Load_LevelSelect_LoadQuickStart
		move.w	#palette_line_0,d3
		bsr.w	Load_LevelSelect_LoadFlashing
...
LevelSelect_Controls:
		...
		cmpi.w	#LeveSelect_FlashingTestCount,d0
		beq.s	LevelSelect_LoadFlashingNumber
		cmpi.w	#LeveSelect_QuickTestCount,d0
		beq.s	LevelSelect_LoadQuickStartNumber
...
LevelSelect_LoadFlashingNumber:
		moveq	#0,d0
		move.w	#2-1,d2
		move.b	(Seizure_flag).w,d0
		bsr.w	LevelSelect_FindLeftRightControls
		move.b	d0,(Seizure_flag).w
		rts
; ---------------------------------------------------------------------------

LevelSelect_LoadQuickStartNumber:
		moveq	#0,d0
		move.w	#2-1,d2
		move.b	(QuickStart_mode).w,d0
		bsr.s	LevelSelect_FindLeftRightControls
		move.b	d0,(QuickStart_mode).w
		rts
; ---------------------------------------------------------------------------
...
LevelSelect_LoadMusicNumber:
		...
		tst.b	(v_LeveSelect_PlayFlag).w
		bne.s	+
		st	(v_LeveSelect_PlayFlag).w
...
Load_LevelSelect_LoadFlashing:
		moveq	#0,d0
		move.b	(Seizure_flag).w,d0
		add.w	d0,d0
		locVRAM	$CA30
		move.w	LevelSelect_LoadFlashingText(pc,d0.w),d0
		lea	LevelSelect_LoadFlashingText(pc,d0.w),a0
		bra.s	Load_LevelSelect_LoadText
; --------------------------------------------------------------------------

Load_LevelSelect_LoadQuickStart:
		moveq	#0,d0
		move.b	(QuickStart_mode).w,d0
		add.w	d0,d0
		locVRAM	$CB30
		move.w	LevelSelect_LoadQuickStartText(pc,d0.w),d0
		lea	LevelSelect_LoadQuickStartText(pc,d0.w),a0
		bra.s	Load_LevelSelect_LoadText
; --------------------------------------------------------------------------
...
LevelSelect_LoadActText: offsetTable
		offsetTableEntry.w LevelSelect_LoadAct21			; DEZ1
		offsetTableEntry.w LevelSelect_LoadAct22		; DEZ2
		offsetTableEntry.w LevelSelect_LoadAct23		; DEZ3
		offsetTableEntry.w LevelSelect_LoadAct24		; DEZ4

		zonewarning LevelSelect_LoadActText,(2*4)
; --------------------------------------------------------------------------

LevelSelect_LoadFlashingText: offsetTable
		offsetTableEntry.w LevelSelect_LoadQuickStart2
		offsetTableEntry.w LevelSelect_LoadQuickStart1
; --------------------------------------------------------------------------

LevelSelect_LoadQuickStartText: offsetTable
		offsetTableEntry.w LevelSelect_LoadQuickStart1
		offsetTableEntry.w LevelSelect_LoadQuickStart2
; --------------------------------------------------------------------------
...
LevelSelect_LoadAct2:
		levselstr "ACT 2"
LevelSelect_LoadAct21:
		levselstr "ACT 2.1"
LevelSelect_LoadAct22:
		levselstr "ACT 2.2"
LevelSelect_LoadAct23:
		levselstr "ACT 2.3"
LevelSelect_LoadAct24:
		levselstr "ACT 2.4"
...
LevelSelect_LoadAct4:
		levselstr "ACT 4"
LevelSelect_Text:
		levselstr "SONIC EPILOGUE - *** DEBUG MODE ***                             "
LevelSelect_LoadQuickStart1:
		levselstr "OFF"
LevelSelect_LoadQuickStart2:
		levselstr "ON"
	even
...
+		cmpi.w	#LeveSelect_ZoneCount,(v_LeveSelect_VCount).w
		bhs.s	+
		bra.w	Load_LevelSelect_LoadAct
+		cmpi.w	#LeveSelect_FlashingTestCount,(v_LeveSelect_VCount).w
		bne.s	+
		bra.w	Load_LevelSelect_LoadFlashing
+		cmpi.w	#LeveSelect_QuickTestCount,(v_LeveSelect_VCount).w
		bne.s	+
		bra.w	Load_LevelSelect_LoadQuickStart
