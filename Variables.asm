...
H_scroll_buffer_End
V_scroll_buffer:						ds.l 512/16				; Vertically scroll table is built up here and then DMAed to VRAM
V_scroll_buffer_End
...
V_scroll_speed:						ds.w 1
V_scroll_speed_bg:					ds.w 1
V_scroll_shift:						ds.l 2
...
SegaCD_Mode:						ds.b 1
QuickStart_mode:						ds.b 1
Intro_RAM:
Intro_flag:							ds.b 1
PauseSkip_Flag:						ds.b 1
GoodMode_flag:						ds.b 1
SegaCD_flag:							ds.b 1
Seizure_flag:							ds.b 1
Checksum_flag:						ds.b 1
SRAMCorrupt_flag:					ds.b 1
SRAMNone_flag:						ds.b 1
...
Update_death_count:					ds.b 1
									ds.b 1
Death_count:							ds.w 1

TimeAttack_Start
TimeAttack_RAM:					ds.l 1*10
TimeAttack_flag:						ds.b 1
TimeAttack_count:					ds.b 1
TimeAttack_DeathRAM:				ds.w 1*10
MiniGame_SaveScore:					ds.l 1
InsertCoin_Flag:						ds.b 1
FirsStart_Flag:						ds.b 1
TimeAttack_End
...
Pos_obj2table_index:					ds.b 1
Pos_obj2table_byte:					ds.b 1
Pos_obj2Table:						ds.b $100				; Recorded position buffer
Pos_objtable_End

Hud_Boss_ArtBuffer:					ds.b $20*8
Oscillating_variables_End

System_stack_size					ds.b $100				; ~$100 bytes ; this is the top of the stack, it grows downwards($FEF0-$FFF0)
System_stack:
Emulator_flag:						ds.b 1
Kega_flag:							ds.b 1
...
; SRAM variables - General
SRAM_Type STRUCT DOTS
	SRAM_Start:

	Initial_Startup:					ds.l 1

	TimeAttack_SRAM:				ds.l 1*10
	TimeAttack_FlagSRAM:			ds.w 1
	TimeAttack_DeathSRAM:			ds.w 1*10
	MiniGame_SaveScore_SRAM:		ds.l 1
	InsertCoin_Flag:					ds.b 1
	FirsStart_Flag:					ds.b 1

	Checksum_SRAM:				ds.w 1		; Last


									ds.b $400-*	; Unused data
