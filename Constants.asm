...
id_SeizureScreen =				id(ptr_GM_Seizure)			; 0
id_InsertCoinScreen =				id(ptr_GM_InsertCoin)		; 4
id_OptionsScreen =				id(ptr_GM_Options)			; 8
id_LevelSelectScreen =				id(ptr_GM_LevelSelect)		; C
id_LevelScreen =					id(ptr_GM_Level)				; 10
id_EndingScreen =				id(ptr_GM_Ending)			; 14
id_DeathScreen =					id(ptr_GM_Death)			; 18
