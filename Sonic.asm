...
Copyright:		dc.b "(C)SEGA 2021.SEP"
Domestic_Name:	dc.b "SONIC 3 & KNUCKLES EPILOGUE DEMO 2021           "
Overseas_Name:	dc.b "SONIC 3 & KNUCKLES EPILOGUE DEMO 2021           "
Serial_Number:	dc.b "GM MK-0000 -01"
Checksum:		dc.w 0
Input:			dc.b "J               "
...
; ---------------------------------------------------------------------------
		...
		dc.b "Please do not hack this hack || Please do not hack this hack || Please do not hack this hack "
	even
...
; ---------------------------------------------------------------------------
	...
	if GameDebug=1
		...
		include "Data/Misc/Security Startup(Release).asm"
	endif
...
; ---------------------------------------------------------------------------
; Load Boss HUD Subroutine
; ---------------------------------------------------------------------------

		include "Data/Misc/Load Boss HUD.asm"

; ---------------------------------------------------------------------------
; Load Death HUD Subroutine
; ---------------------------------------------------------------------------

		include "Data/Misc/Load Death HUD.asm"
...
; ---------------------------------------------------------------------------
		...
		include "Objects/Sonic/Sonic Flying.asm"
		include "Objects/Sonic/Sonic Rocket.asm"
...
; ---------------------------------------------------------------------------
; Terminal screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/Terminal/Terminal.asm"

; ---------------------------------------------------------------------------
; SRAM screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/SRAM/SRAM.asm"

; ---------------------------------------------------------------------------
; MiniGame screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/MiniGame/MiniGame.asm"

; ---------------------------------------------------------------------------
; Seizure screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/Seizure/Seizure.asm"

; ---------------------------------------------------------------------------
; Options screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/Insert Coin/Insert Coin.asm"
...
; ---------------------------------------------------------------------------
		...
		include "Data/Screens/Time Attack/Time Attack.asm"
...
; ---------------------------------------------------------------------------
; HardLine screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/HardLine/HardLine.asm"

; ---------------------------------------------------------------------------
; Prologue screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/Prologue/Prologue.asm"

; ---------------------------------------------------------------------------
; SHC screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/SHC/SHC.asm"

; ---------------------------------------------------------------------------
; Transition screen subroutines
; ---------------------------------------------------------------------------

		include "Data/Screens/Transition/Transition.asm"
...
; ---------------------------------------------------------------------------
; Death screen Subroutine
; ---------------------------------------------------------------------------

		include "Data/Screens/Death/Death.asm"
...
; ---------------------------------------------------------------------------
; Emudetect Subroutine
; ---------------------------------------------------------------------------

		include "Data/Misc/Emudetect.asm"

; ---------------------------------------------------------------------------
; Archive
; ---------------------------------------------------------------------------

		binclude "Misc Data/Archive/Archive.7z"
	even
