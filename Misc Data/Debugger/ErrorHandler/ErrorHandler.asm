...
BusError:
	__ErrorMessage "%<.l Str_PtrContactInfo str>BUS ERROR", _eh_default|_eh_address_error|_eh_disassemble

AddressError:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ADDRESS ERROR", _eh_default|_eh_address_error|_eh_disassemble

IllegalInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ILLEGAL INSTRUCTION", _eh_default|_eh_disassemble

ZeroDivide:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ZERO DIVIDE", _eh_default|_eh_disassemble

ChkInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>CHK INSTRUCTION", _eh_default|_eh_disassemble

TrapvInstr:
	__ErrorMessage "%<.l Str_PtrContactInfo str>TRAPV INSTRUCTION", _eh_default|_eh_disassemble

PrivilegeViol:
	__ErrorMessage "%<.l Str_PtrContactInfo str>PRIVILEGE VIOLATION", _eh_default|_eh_disassemble

Trace:
	__ErrorMessage "%<.l Str_PtrContactInfo str>TRACE", _eh_default|_eh_disassemble

Line1010Emu:
	__ErrorMessage "%<.l Str_PtrContactInfo str>LINE A EMULATOR", _eh_default|_eh_disassemble

Line1111Emu:
	__ErrorMessage "%<.l Str_PtrContactInfo str>LINE F EMULATOR", _eh_default|_eh_disassemble

ErrorExcept:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ERROR EXCEPTION", _eh_default|_eh_disassemble

ErrorTrap:
	__ErrorMessage "%<.l Str_PtrContactInfo str>ERROR TRAP", _eh_default|_eh_disassemble
