...
Ani_Sonic:
		...
		dc.w SonAni_Grab-Ani_Sonic			; 20
		dc.w SonAni_Wait3-Ani_Sonic			; 21
		dc.w SonAni_Assault-Ani_Sonic			; 22
		dc.w SonAni_Sparkster-Ani_Sonic		; 23
...
SonAni_Wait2:		dc.b  $E, $BA, $FF, 0
SonAni_Grab:		dc.b  2, $B4, $B5, $FF, 0
SonAni_Wait3:		dc.b  $E, $BA, $FF, 0
SonAni_Assault:		dc.b  $E, $DA, $FF, 0
SonAni_Sparkster:	dc.b  1, $DB, $DC, $FF, 0
	even
