...
; Stage 2
		...
		offsetTableEntry.w ObjData_BossMiniOrbinaut_Level13						; 42
		offsetTableEntry.w ObjData_BossMiniOrbinaut_Level14						; 44
		...
		offsetTableEntry.w ObjData_BossMiniOrbinaut_Level18						; 4C
...
BossMiniOrbinaut_DialogIndex:
		...
		dc.l 0																																	; 4A
		dc.l 0																																	; 4C
		dc.l ((DialogMiniOrbinautBattle8_Process_Index_End-DialogMiniOrbinautBattle8_Process_Index)/8)<<24|(DialogMiniOrbinautBattle8_Process_Index-4)	; 4E
; ---------------------------------------------------------------------------
...
+		bsr.w	Obj_ChasingBall_CopyPos
		...
		move.w	#$E1F0,art_tile(a0)
		btst	#0,(Level_frame_counter+1).w
		beq.s	+
		move.w	#$A1F0,art_tile(a0)
+		jmp	(Child_DrawTouch_Sprite3_FlickerMove).w
; ---------------------------------------------------------------------------
