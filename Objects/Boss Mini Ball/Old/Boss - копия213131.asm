...
BossMiniOrbinaut_Multitude_CheckTouch:
		...
		adda.w	d0,a3
		move.l	(a3),d3
		bpl.s	BossMiniOrbinaut_Multitude_CheckTouch_LoadIntro
		move.w	#$9F,$2E(a2)
...
BossMiniOrbinaut_Multitude_CheckTouch_LoadIntro:
		...
		lea	ChildObjDat_Dialog_Process(pc),a2
		jsr	(CreateChild6_Simple).w
		bne.s	BossMiniOrbinaut_Multitude_CheckTouch_LoadIntro_Return
...
BossMiniOrbinaut_DialogIndex:
		...
		dc.l -1																																	; E
		dc.l -1																																	; 10
		dc.l ((DialogMiniOrbinautBattle4_Process_Index_End-DialogMiniOrbinautBattle4_Process_Index)/8)<<24|(DialogMiniOrbinautBattle4_Process_Index-4)	; 12
		dc.l -1
		dc.l -1
		dc.l ((DialogMiniOrbinautBattle5_Process_Index_End-DialogMiniOrbinautBattle5_Process_Index)/8)<<24|(DialogMiniOrbinautBattle5_Process_Index-4)	; 5
		dc.l -1
		dc.l -1
		dc.l ((DialogMiniOrbinautBattle6_Process_Index_End-DialogMiniOrbinautBattle6_Process_Index)/8)<<24|(DialogMiniOrbinautBattle6_Process_Index-4)	; 6
		dc.l -1
		dc.l -1
		dc.l ((DialogMiniOrbinautBattle7_Process_Index_End-DialogMiniOrbinautBattle7_Process_Index)/8)<<24|(DialogMiniOrbinautBattle7_Process_Index-4)	; 7
		dc.l -1
		dc.l -1



		dc.l ((DialogMiniOrbinautBattle8_Process_Index_End-DialogMiniOrbinautBattle8_Process_Index)/8)<<24|(DialogMiniOrbinautBattle8_Process_Index-4)	; 50
; ---------------------------------------------------------------------------
...
Obj_BossMiniOrbinaut_ChairLeft:
		...
		move.l	#BossMiniOrbinaut_ChairLeft_Main,address(a0)
		move.b	#8/2,child_dx(a0)
		move.b	#6/2,child_dy(a0)

BossMiniOrbinaut_ChairLeft_Main:
		movea.w	$44(a0),a1
		btst	#1,$38(a1)
		beq.s	BossMiniOrbinaut_ChairLeft_MainMinus

		addq.b	#8,child_dx(a0)
		cmpi.b	#134/2,child_dx(a0)
		ble.s		BossMiniOrbinaut_ChairLeft_MainMove
		move.b	#134/2,child_dx(a0)
		bra.s	BossMiniOrbinaut_ChairLeft_MainMove
; ---------------------------------------------------------------------------

BossMiniOrbinaut_ChairLeft_MainMinus:
		subq.b	#8,child_dx(a0)
		cmpi.b	#8/2,child_dx(a0)
		bge.s	BossMiniOrbinaut_ChairLeft_MainMove
		move.b	#8/2,child_dx(a0)

BossMiniOrbinaut_ChairLeft_MainMove:
		movea.w	$44(a0),a1
		btst	#0,$38(a1)
		beq.s	BossMiniOrbinaut_ChairLeft_Main2
		subq.b	#4,child_dy(a0)
		cmpi.b	#-58/2,child_dy(a0)
		bge.s	BossMiniOrbinaut_ChairLeft_Setup
		move.b	#-58/2,child_dy(a0)
		bra.s	BossMiniOrbinaut_ChairLeft_Setup
; ---------------------------------------------------------------------------

BossMiniOrbinaut_ChairLeft_Main2:
...
Obj_BossMiniOrbinaut_ChairMiddle:
		...
		move.l	#BossMiniOrbinaut_ChairMiddle_Main,address(a0)
		move.b	#-8/2,child_dx(a0)

BossMiniOrbinaut_ChairMiddle_Main:
		movea.w	$44(a0),a1
		btst	#1,$38(a1)
		beq.s	BossMiniOrbinaut_ChairMiddle_MainMinus

		addq.b	#4,child_dx(a0)
		cmpi.b	#54/2,child_dx(a0)
		ble.s		BossMiniOrbinaut_ChairMiddle_MainMove
		move.b	#54/2,child_dx(a0)
		bra.s	BossMiniOrbinaut_ChairMiddle_MainMove
; ---------------------------------------------------------------------------

BossMiniOrbinaut_ChairMiddle_MainMinus:
		subq.b	#4,child_dx(a0)
		cmpi.b	#-8/2,child_dx(a0)
		bge.s	BossMiniOrbinaut_ChairMiddle_MainMove
		move.b	#-8/2,child_dx(a0)

BossMiniOrbinaut_ChairMiddle_MainMove:
		movea.w	$44(a0),a1
		btst	#0,$38(a1)
		beq.s	BossMiniOrbinaut_ChairMiddle_Main2
		subq.b	#4,child_dy(a0)
		cmpi.b	#6/2,child_dy(a0)
...
BossMiniOrbinaut_ChairMiddle_Main2:
		addq.b	#4,child_dy(a0)
