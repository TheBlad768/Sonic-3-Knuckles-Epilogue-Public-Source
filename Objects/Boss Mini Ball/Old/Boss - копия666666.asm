...
BossMiniOrbinaut_Process_Load:
		...
		move.w	(a4)+,d5								; Total
		bmi.s	BossMiniOrbinaut_Process_Error2

-		move.w	(a4),d1								; Obj
		lea	(a4,d1.w),a2
		addq.w	#2,a4
		jsr	(CreateChild6_Simple).w
		bne.s	BossMiniOrbinaut_Process_Error2
...
BossMiniOrbinaut_Process_Error2:
		illegal

BossMiniOrbinaut_Process_Error:
		illegal
; ---------------------------------------------------------------------------
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_Multitude				; 0
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_Circular_Control			; 1
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_CircularRotation_Control	; 2
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_Box_Control				; 3
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_BoxJump_Control		; 4
;		offsetTableEntry.w ChildObjDat_BossMiniOrbinaut_Snake					; 5
; ---------------------------------------------------------------------------
