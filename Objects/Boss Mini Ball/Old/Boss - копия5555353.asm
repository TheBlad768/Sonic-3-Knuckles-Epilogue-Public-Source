...
+		add.w	d1,d0
		...
		move.w	#$F,$2E(a0)
		move.l	#BossMiniOrbinaut_Chair_Control_SetFall,$34(a0)
...
BossMiniOrbinaut_Chair_Control_SetFall:
		move.b	#_Setup2,routine(a0)
		move.l	#BossMiniOrbinaut_Chair_Control_Wait,$34(a0)
		clr.w	y_vel(a0)
		rts
; ---------------------------------------------------------------------------

BossMiniOrbinaut_Chair_Control_Wait:
		rts
...
Obj_BossMiniOrbinaut_ChairLeft:
		...
		tst.b	subtype(a0)
		bne.s	BossMiniOrbinaut_ChairLeft_Main
