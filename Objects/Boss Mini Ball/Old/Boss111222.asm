...
BossMiniOrbinaut_Index: offsetTable
		...
		offsetTableEntry.w ObjData_BossMiniOrbinaut_LevelF						; 30
		offsetTableEntry.w ObjData_BossMiniOrbinaut_Level1						; 32
...
+		add.w	d1,d0
		...
		move.b	#96,collision_property(a0)
...
BossMiniOrbinaut_SmallCircular_Control_JumpDeceleration:
		...
		cmpi.b	#8,objoff_3E(a0)		; Y
		bne.s	BossMiniOrbinaut_SmallCircular_Control_JumpDeceleration_Return
		move.w	#$F,$2E(a0)
...
BossMiniOrbinaut_SmallCircular_Control_JumpAcceleration:
		...
		cmpi.b	#30,objoff_3E(a0)		; Y
		bne.s	BossMiniOrbinaut_SmallCircular_Control_JumpAcceleration_Return
		move.b	#30,objoff_3A(a0)		; X
		move.b	#30,objoff_3E(a0)		; Y
...
BossMiniOrbinaut_SmallCircular_CheckTouch:
		...
		bne.w	BossMiniOrbinaut_SmallCircular_CheckTouch_Return
		tst.b	$1C(a0)
		bne.s	BossMiniOrbinaut_SmallCircular_CheckTouch_Flash

BossMiniOrbinaut_SmallCircular_CheckTouch_HitBoss:
		move.b	#$60,$1C(a0)
		bset	#6,status(a0)
...
BossMiniOrbinaut_SmallCircular_CheckTouch_Flash:
		subq.b	#1,$1C(a0)
...
Obj_BossMiniOrbinaut_CircularRotation:
		...
		move.l	#BossMiniOrbinaut_CircularRotation_Setup,address(a0)

BossMiniOrbinaut_CircularRotation_Setup:
		jsr	(Find_SonicTails).w
		jsr	(Change_FlipX).w
		addq.b	#4,objoff_3C(a0)
		jsr	(MoveSprite_Circular).w
...
BossMiniOrbinaut_Box_CheckTouch:
		tst.b	$1D(a0)
		beq.w	BossMiniOrbinaut_Box_CheckTouch_Return
		tst.b	collision_property(a0)
...
Obj_BossMiniOrbinaut_BoxRight:
		...
		move.b	#-28,child_dy(a0)
+		bra.s	BossMiniOrbinaut_BoxLeft_Setup
; ---------------------------------------------------------------------------
; Столб из кучи маленьких босс-шаров
; ---------------------------------------------------------------------------
