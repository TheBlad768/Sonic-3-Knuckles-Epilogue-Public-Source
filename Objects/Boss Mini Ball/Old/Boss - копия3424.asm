...
BossMiniOrbinaut_SmallCircular_CheckTouch_RestoreCollision2:
...
BossMiniOrbinaut_Box_CheckTouch:
		tst.b	$1D(a0)
		bmi.s	BossMiniOrbinaut_Box_Control_WaitJump2_Return
		beq.s	BossMiniOrbinaut_Box_Control_WaitJump2_Return
		tst.b	collision_property(a0)
