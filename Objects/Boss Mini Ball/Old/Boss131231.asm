...
BossMiniOrbinaut_Process_Load:
		...
		lea	ChildObjDat_BossMiniOrbinaut_BoxJump_Control(pc),a2
...
BossMiniOrbinaut_Circular_Control_Init:
		...
		move.b	#93,collision_property(a0)
